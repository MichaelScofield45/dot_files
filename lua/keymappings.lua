...
vim.api.nvim_create_user_command("CompilePandoc", myfuncs.pandoc_compile, {})
vim.api.nvim_create_user_command("SetCompileCommand", myfuncs.pandoc_command, {})
vim.keymap.set("n", "<leader>pd", myfuncs.pandoc_compile)
